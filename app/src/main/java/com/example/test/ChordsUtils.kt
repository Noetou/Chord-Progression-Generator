...
class ChordsUtils {
    ...
    companion object {
        ...
        public  fun generateChordList(): ArrayList<Accord> {
            ...
            chordList.add(Accord("Cm", R.drawable.c_minor_chord_for_guitar, arrayListOf<String>("Cm","Fm","Gm","G#","A#","D#")))
            ...
            chordList.add(Accord("Gm", R.drawable.g_minor_chord_for_guitar, arrayListOf<String>("Cm","Dm","F","A#","D#")))
